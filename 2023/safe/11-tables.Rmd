...
output$biomass_by_strata %>%
  ...
  flextable::set_caption("Flathead sole survey biomass (Bio, t) and coefficient of variation (CV) by year and regulatory area. Bolded years are not included in base model. Small discrepancies (<1 t) in Total column may occur due to rounding.") %>%
  ...
  flextable::vline(j = c(1,3), part = 'all')
```
