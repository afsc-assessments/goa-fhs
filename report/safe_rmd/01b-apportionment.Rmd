...
The following table shows the recommended ABC apportionment for `r year+1` and `r year+2`. The author notes that in previous projections of the `r species` model (including those one in 2021), the time series of recruitment and spawning biomass began in 1984 (the start of the main period for recruitment deviations), not 1977 as requested by a 1999 memo by R. Marasco. For consistency between previous assessments and the current assessment (`r base_model_name`), inputs to the correction module continue to use the time series of recruitment and SSB beginning in 1984, which corresponds to the onset of most survey data. Projections assume recruitment at age 3.
