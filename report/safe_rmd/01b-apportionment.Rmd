...
The following table shows the recommended ABC apportionment for `r year` and `r year +1`. The author notes that in previous projections of the `r species` model (including those one in 2021), the time series of recruitments and spawning biomass began in 1984 (the start of the main period for recruitment deviations), not 1977 as required by a 1999 memo by R. Maraso. For the present assessment (`r base_model_name`), inputs to the projection module have been corrected to use the time series of recruitment and SSB beginning in 1977. Projections assume recruitment at age 3.
