...
`r old_model_name` and `r base_model_name`  have very similar spawning biomass (\@ref(fig:ssbcompare)), survey biomass (\@ref(fig:idxcompare)), recruitment (\@ref(fig:idxcompare)), fishing mortality (\@ref(fig:Fcompare)), and stock status. Estimated growth curves were also very similar (Table 9.13; Figure 9.13, 9.14). The results are similar in expectation and uncertainty, corroborating the stable nature of the model to data and configurations found previously [@Turnock2017].
