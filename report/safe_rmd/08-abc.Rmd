...
Because the `r species` stock has not been overfished in recent years and the stock biomass is relatively high, it is not recommended to adjust FABC downward from its upper bound.
