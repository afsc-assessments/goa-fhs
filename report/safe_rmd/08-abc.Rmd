...
: Unnumbered Table. Harvest recommendations from Model 17.1a. Values are from the projection model and should not be compare directly to outputs from Stock Synthesis forecast outputs.
