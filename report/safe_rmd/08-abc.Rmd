...
The `r year` estimates of these reference points are shown below. Values are from the projection model for `r base_model_name` and should not be compared directly to outputs from Stock Synthesis forecast outputs.
