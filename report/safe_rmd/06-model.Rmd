...
factor following Methot and Taylor (2011). The breakpoints for the bias adjustment ramp are shown in Figure \@ref(fig:biasramp), and are characterized by a linear
