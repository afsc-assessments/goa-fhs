...
selectivity parameters by fleet and sex are presented in Table \@ref(tbl-selex).
...
In `r old_model_name`, and the 2015 assessment that preceded it, the method described in Francis (2011) was not used because of concerns raised about its use when using conditional age-at-length data. The effective sample size for length composition data was changed to the number of hauls (Volstad and
