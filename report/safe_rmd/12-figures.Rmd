...
```{r aydindiet, echo = FALSE,  fig.cap="Diet composition for Gulf of Alaska juveniles (left) and adults (right) flathead sole from the GOA ecosystem model (data fromAydin et al., 2007).", eval = T, echo = FALSE}
