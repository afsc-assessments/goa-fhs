...
```{r lencompfit4, fig.cap="(ref:lencompcap). Data shown for the Survey.", eval = T}
...
(ref:SSBcap) Time series of estimated spawning stock biomass (Mt) over time (solid blue line and circles) and asymptotic 95% confidence intervals (blue dashed lines) for the 2022 base case model. Point at 1977 is virgin biomass.

```{r SSBts, fig.cap="(ref:SSBcap)",  eval = T}
