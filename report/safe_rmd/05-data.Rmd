...
The assessment included catch data from `r min(base_model$catch$Yr)` to `r date` (Figure 10.\@ref(fig:removals)). Historically, catches have been well below the management specifications, on the order of 10% of Total Allowable Catch over the last 10 years (Figure 10.\@ref(fig:catchvsTAC)).  Catches of flathead sole occur almost entirely in the Western and Central management areas in the GOA (statistical areas 610 and 620 + 630, respectively, (Table 10.\@ref(tab:catchbyarea)). 
