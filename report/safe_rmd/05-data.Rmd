...
(ref:ssfilesource) used in the assessment can be seen in the Stock Synthesis data file (`data.dat`) hosted here: https://github.com/mkapur-noaa/goa-fhs-2022/ModelFiles_PlanTeam.
...
Fishery length composition data were included in 2cm bins from `r paste0(range(base_model$lbins), collapse = "-")` cm in `r with(subset(base_model$lendbase, Fleet == 1),paste0(unique(Yr), collapse = ", "))`. These data were current on AKFIN as of  `r date`. Compositional data were omitted in years where there were less than 15 hauls that included measured flathead sole: `r paste0(c(1982:2022)[which(!(1982:2022 %in%  unique(base_model$lendbase$Yr)))], collapse =", ")`. The effective sample size for fishery length composition data were the annual number of hauls [@Pennington1994]. Fishery length composition observations (ref:ssfilesource)
