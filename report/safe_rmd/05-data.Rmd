...
The total survey biomass estimates and CVs that were used in the assessment are listed in (Table 5).  Survey biomass decreased slightly from `r prettyNum(base_model$cpue$Obs[base_model$cpue$Yr==2019], big.mark = ',')` t in 2019 to `r prettyNum(base_model$cpue$Obs[base_model$cpue$Yr==2021], big.mark = ',')` t in 2021.
