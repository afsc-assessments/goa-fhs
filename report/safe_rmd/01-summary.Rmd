...
```
 * Projections are based on  catches of `r c1` t (through `r date`) used in place of maximum permissible ABC for `r year` and `r c2` t used in place of maximum permissible ABC for `r year+1` and `r year+2`. The `r year+1` and `r year+2` catch was estimated as the average of the total catch in each of the last 5 years (`r paste0(c(year-5,year-1), collapse = "-")`). 
