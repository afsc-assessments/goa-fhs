...
names(catch_area) <- c('Year','Total Catch (mt)','Western Gulf','Central Gulf','Eastern Gulf')
flextable::regulartable(catch_area) %>%  
      flextable::set_caption("Total and regional observed annual catch (mt) of GOA Flathead sole through Oct 13,2022. Data are from NMFS Observer Program and Alaska Regional Office. Note that in the base model, a total catch of 687 mt was used as the 2022 full year estimate.") %>%
