...
The ABC for flathead sole is `r prettyNum(abc_25,big.mark = ',')`  t in `r this_year+1`  and `r prettyNum(abc_25,big.mark = ',')` t in `r this_year+2`  and the OFL is `r prettyNum(ofl_25,big.mark = ',')`  t in `r this_year+1`  and `r prettyNum(ofl_25,big.mark = ',')`  t in `r this_year+2`. 
