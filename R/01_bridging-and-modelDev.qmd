...
# SSplotComparisons(SSsummarize(list(m0_0,m0_4)),
#                   plot = FALSE, png = T,
...
# SSplotComparisons(SSsummarize(list(m0_0,m0_1,m0_2,m0_3)),  plot = FALSE, png = T, plotdir = here('model_runs','m0_3'), uncertainty=TRUE,  legendlabels =  models,indexPlotEach = T)
```
...
# plot = FALSE, png = T, plotdir = here('model_runs','m0_4'), uncertainty=TRUE,  legendlabels = models,indexPlotEach = T)
```
...
# SSplotComparisons(SSsummarize(list(m0_0,m0_1,m0_2,m0_3,m0_4,m0_5)),  plot = FALSE, png = T, plotdir = here('model_runs','m0_5'), uncertainty=TRUE,  legendlabels = models,indexPlotEach = T)
...
## double check error matrices are indeed distinct
m0_6$age_error_mean; m0_4$age_error_mean; m0_8$age_error_mean
# SS_plots(m0_8,   png = T, dir =   here('model_runs','m0_8'))
SSplotComparisons(SSsummarize(list(m0_0,m0_6,m0_4,m0_8)),  plot = T, png = F, plotdir = here('model_runs','m0_8'), uncertainty=TRUE,  legendlabels = models, indexPlotEach = T, subplots = c(2,11,13))
...
SSplotComparisons(SSsummarize(list(m0_8,m0_8c)), subplots = c(2,13),
                  legendlabels = c('m0_8','m0_8c [no weights]'))
...
SSplotComparisons(SSsummarize(list(m2017, m0_8,m0_8c,m0_8newMI,m0_8newFrancis)),
...
m0_8newMIbias <- SS_output(here('model_runs','m0_8-newMI-biasAdj'), covar=TRUE, verbose=FALSE, printstats=FALSE)
