...
q.vec <- log(seq(0.6, 5, 0.1)) ## from 2017
...
SSplotProfile(profile_q_summary, # summary object
              add_cutoff = T, ymax = 50, legendloc = 'right',
...
## Survey data 1993
Turned off survey data, CAALs and length comp before 1993 from the survey. (Made plots in 02_basemodel for aesthetic consistency).
