...
for(i in c('Eastern','Western','Central'))
  tempdir <- here('re','central')
lastfiles <- list.files(here('re','2021_areaapportionment','central'), full.names = TRUE)
file.copy(from = lastfiles, to  = tempdir)
## paste in values_for_redat in correct order based on endyr
## change to tempdir and run rwout
## now ready to wrangle or read into rema
