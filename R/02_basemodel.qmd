...
ggplot2::theme_set(ggsidekick::theme_sleek( base_size = 7))
theme_replace(text= element_text(family = "roboto condensed", size = 3),
...
ggplot(data=subset(lencomp_hauls, src == 'base'), aes(x = Yr, y = Nsamp, color = src)) +
  ...
  labs(title = 'Input Sample Sizes (nhauls) by fleet, length comps')
