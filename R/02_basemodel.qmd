...
legend.labels <- c(base_model_name, old_model_name)
summaryoutput <- r4ss::SSsummarize(list(base_model, m2017))
 
SStableComparisons(summaryoutput,likenames=like, names=growthPars, modelnames=legend.labels,   csv=TRUE, csvdir = here('tables'), 
                   csvfile='parcompare_growth.csv')

 
SStableComparisons(summaryoutput,likenames=like, names=selexPars, modelnames=legend.labels,   csv=TRUE,csvdir = here('tables'), 
                   csvfile='parcompare_selex.csv')
```
