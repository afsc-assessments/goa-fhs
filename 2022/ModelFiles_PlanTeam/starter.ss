...
-1 # min yr for sdreport outputs (-1 for styr); #_1976
-1 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2018
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1626279999
